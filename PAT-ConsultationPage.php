	...
	<body>
		...
		<div class="body">
			<section class="contentContainer">
				<form class="patientConsultation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
					<div class="patientConsultation" id="patientConsultation">
						<label for="patientConsultationTitle" id="patientConsultationTitle"><b>Manage Consultations</b></label>
						...
						<label for="BookorChangeConsultationTitle" id="BookorChangeConsultationTitle"><b>Book or Change Consultations</b></label>
						<p>Fill in the followowing fields to <b>book</b> or <b>change</b> consultations.</p>
						...
						<div class="btnGroup">
							<button type="submit" name="submit" id="bookbtn">Book</button>
					...
					<div class="patientConsultation" style="background-color:#f1f1f1">
